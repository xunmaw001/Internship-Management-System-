...
//            jianli.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        if("".equals(jianli.getJiaoyuText()) || "null".equals(jianli.getJiaoyuText())){
                jianli.setJiaoyuText(null);
        }
        if("".equals(jianli.getShixiText()) || "null".equals(jianli.getShixiText())){
                jianli.setShixiText(null);
        }
        if("".equals(jianli.getGerenText()) || "null".equals(jianli.getGerenText())){
                jianli.setGerenText(null);
        }
